...
def patient(request):
    if request.method == 'POST':
        ...
        patientinfo = patientInfo(fullName=fullName, age=age, address=address, phonenumber=phonenumber, bloodgroup=bloodgroup)
        if request.user.is_authenticated:
            user = request.user
...
def patientlist(request):
    ...
    return render(request, 'html/patientlist.html', context)
